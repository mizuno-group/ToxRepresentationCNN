...
class TGGATEBalancedSampler(WeightedRandomSampler):
    def __init__(self, dataset, n_samples):
        # if dataset.mode == "finding type" or dataset.mode == "compound":
        if True:  # あとでなおす
            ...
            super().__init__(weights, int(n_samples * len(dataset)))
        else:
            print("invalid mode")
